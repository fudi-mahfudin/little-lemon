import { Dispatch, FC, HTMLAttributes, useEffect } from "react"
import { NavigateFunction, useNavigate } from "react-router-dom";
import { Container, Form, Top, FormMessageError } from "./styles";
...
const BookingForm: FC<BookingFormProps> = ({
  ...
  return (
    <Container {...props} id="booking">
      <Top>
        <h1>Book Now</h1>
      </Top>
      <Form onSubmit={formik.handleSubmit} noValidate>
        <label htmlFor="res-date">Choose date</label>
        <input type="date" data-testid="res-date" {...formik.getFieldProps("date")} />
